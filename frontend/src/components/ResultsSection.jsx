...
export function ResultsSection({ resultRows, setResultRows, summary, exportReady, studentName, tableUpdated }) {
  ...
  return (
    <>
      ...
      {tableUpdated && (
        <div className="fixed left-1/2 top-5 z-50 -translate-x-1/2 animate-[fadeInDown_0.3s_ease] rounded-2xl border border-green-200 bg-green-50 px-5 py-3 shadow-lg">
          <div className="flex items-center gap-2 text-sm font-medium text-green-700">
            ...
            Results updated based on your latest changes.
          </div>
        </div>
      )}
